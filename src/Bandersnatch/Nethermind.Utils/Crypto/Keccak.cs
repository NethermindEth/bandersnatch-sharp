...
namespace Nethermind.Core.Crypto
{
    ...
    public class Keccak : IEquatable<Keccak>, IComparable<Keccak>
    {
        ...
        public Keccak(string hexString)
            : this(Utils.Extensions.Bytes.FromHexString(hexString)) { }
        ...
        public bool Equals(Keccak? other)
        {
            ...
            return Utils.Extensions.Bytes.AreEqual(other.Bytes, Bytes);
        }

        public int CompareTo(Keccak? other)
        {
            return Utils.Extensions.Bytes.Comparer.Compare(Bytes, other?.Bytes);
        }
        ...
        public static bool operator ==(Keccak? a, Keccak? b)
        {
            ...
            return Utils.Extensions.Bytes.AreEqual(a.Bytes, b.Bytes);
        }
        ...
        {
            return Utils.Extensions.Bytes.Comparer.Compare(k1?.Bytes, k2?.Bytes) > 0;
        }
    ...
    public ref struct KeccakStructRef
    {
        ...
        public bool Equals(KeccakStructRef other) => Utils.Extensions.Bytes.AreEqual(other.Bytes, Bytes);
