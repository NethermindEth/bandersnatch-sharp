...
namespace Nethermind.Utils.Crypto
{
    public class CommitmentHash
    {
        ...
        private CommitmentHash(int size)
        {
            // Set the hash size
            HashSize = size;
            ...
            {
                throw new ArgumentException($"Invalid Commitment hash size. Must be between 0 and {STATE_SIZE}.");
            }
        ...
        private static void CommitmentF(Span<ulong> st)
        {
        ...
        public void Update(Span<byte> array, int index, int size)
        {
            ...
            if (_remainderLength != 0)
            {
                ...
                if (_remainderLength == _roundSize)
                {
                    ...
                    // Perform our CommitmentF on our state.
                    CommitmentF(_state.Span);
