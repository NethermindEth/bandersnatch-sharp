...
namespace Nethermind.Field.Montgomery.FrEElement
{
    public readonly partial struct FrE
    {
        ...
        private static bool LessThan(in FrE a, long b)
        {
            return b >= 0 && a.u3 == 0 && a.u2 == 0 && a.u1 == 0 && a.u0 < (ulong)b;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool LessThan(long a, in FrE b)
        {
            return a < 0 || b.u1 != 0 || b.u2 != 0 || b.u3 != 0 || (ulong)a < b.u0;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool LessThan(in FrE a, ulong b)
        {
            return a.u3 == 0 && a.u2 == 0 && a.u1 == 0 && a.u0 < b;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool LessThan(ulong a, in FrE b)
        {
        ...
        {
            return obj is FrE other && Equals(other);
        }

        public bool Equals(FrE other)
        {
