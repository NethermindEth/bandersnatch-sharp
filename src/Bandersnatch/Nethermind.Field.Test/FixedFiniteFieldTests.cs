...
namespace Nethermind.Field.Test
{
    ...
    public struct TestBandersnatchScalarFieldStruct : IFieldDefinition
    {
        ...
        {
            225, 231, 118, 40, 181, 6, 253, 116, 113, 4, 25, 116, 0, 135, 143, 255, 0, 118, 104, 2, 2, 118, 206, 12, 82, 95, 103, 202, 212, 105, 251, 28
        };
        public readonly UInt256 FieldMod => new UInt256(ModBytes);
    }
    ...
    public class FixedFiniteFieldTests
    {
        ...
        public void TestMultiInv()
        {
            Ft[] values =
            {
                new Ft((UInt256)1), new Ft((UInt256)2), new Ft((UInt256)3)
            };
