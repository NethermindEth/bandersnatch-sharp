...
namespace Nethermind.Tree.Forest
{
    public partial class TrieNode
    {
        ...
        internal void Accept(ITreeVisitor visitor, Pruning.ITrieNodeResolver nodeResolver, TrieVisitContext trieVisitContext)
        {
            try
            {
                ...
                case NodeType.Branch:
                    {
                        ...
                        void VisitChild(int i, TrieNode? child, Pruning.ITrieNodeResolver resolver, ITreeVisitor v, TrieVisitContext context)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        void VisitSingleThread(ITreeVisitor treeVisitor, Pruning.ITrieNodeResolver trieNodeResolver, TrieVisitContext visitContext)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        void VisitMultiThread(ITreeVisitor treeVisitor, Pruning.ITrieNodeResolver trieNodeResolver, TrieVisitContext visitContext, TrieNode?[] children)
                        {
                            // multithreaded route
