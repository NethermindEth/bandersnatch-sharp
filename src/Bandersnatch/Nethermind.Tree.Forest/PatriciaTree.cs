...
namespace Nethermind.Tree.Forest
{
    ...
    public class PatriciaTree
    {
        ...
        public readonly Pruning.ITrieStore TrieStore;
        ...
        public PatriciaTree(Pruning.ITrieStore trieStore, ILogManager logManager)
        ...
        [DebuggerStepThrough]
        public byte[]? Get(Span<byte> rawKey, Commitment? rootHash = null)
        {
            try
            {
