...
public class MonomialBasis: IEqualityComparer<MonomialBasis>
{
    ...
    {
        var output = new Fr[a.Length() + b.Length() - 1];
    ...
    {
        var derivative = new Fr?[f.Length() - 1];
        for (int i = 1; i < f.Length(); i++)
        {
            var x = new Fr(i) * f.Coeffs[i]!;
            derivative[i-1] = x;
        }
