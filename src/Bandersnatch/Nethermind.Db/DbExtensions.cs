...
namespace Nethermind.Db
{
    public static class DbExtensions
    {
        ...
        public static TItem? Get<TItem>(this IDb db, Commitment key, IRlpStreamDecoder<TItem> decoder, ICache<Commitment, TItem> cache = null, bool shouldCache = true) where TItem : class
        {
