...
namespace Nethermind.Field
{
    public class FiniteField : IComparable<FiniteField>, IComparable, IEqualityComparer<FiniteField>
    {
        ...
        {
            return obj is not FiniteField finiteField
        ...
        private static FiniteField Zero(UInt256 modulus)
        {
            return new FiniteField(UInt256.Zero, modulus);
        }
        private static FiniteField One(UInt256 modulus)
        {
            return new FiniteField(UInt256.One, modulus);
        }
        ...
        public int Legendre()
        {
            return FieldMethods.LegendreSymbol(Value, Modulus);
        }
