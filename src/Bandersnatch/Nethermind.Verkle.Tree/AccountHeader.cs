...
namespace Nethermind.Verkle.Tree
{
    public readonly struct AccountHeader
    {
        ...
        public static byte[] GetTreeKeyPrefixAccount(byte[] address)
        {
        ...
        public static byte[] GetTreeKeyForVersion(byte[] address)
        {
            return GetTreeKey(address, UInt256.Zero, Version);
        }
        public static byte[] GetTreeKeyForBalance(byte[] address)
        {
            return GetTreeKey(address, UInt256.Zero, Balance);
        }
        public static byte[] GetTreeKeyForNonce(byte[] address)
        {
            return GetTreeKey(address, UInt256.Zero, Nonce);
        }
        public static byte[] GetTreeKeyForCodeCommitment(byte[] address)
        {
            return GetTreeKey(address, UInt256.Zero, CodeHash);
        }
        public static byte[] GetTreeKeyForCodeSize(byte[] address)
        {
            return GetTreeKey(address, UInt256.Zero, CodeSize);
        }
