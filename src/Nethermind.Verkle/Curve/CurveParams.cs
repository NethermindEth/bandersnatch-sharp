...
namespace Nethermind.Verkle.Curve
{
    public readonly struct CurveParams
    {
        ...
        {
            102, 65, 151, 204, 182, 103, 49, 94, 96, 100, 228, 238, 129, 173, 140, 53, 134, 213, 220, 186, 80, 139,
            125, 21, 15, 62, 18, 218, 158, 102, 108, 42
        };

        public static byte[] NumX { get; } =
        {
            24, 174, 82, 162, 102, 24, 231, 225, 101, 132, 153, 173, 34, 192, 121, 43, 243, 66, 190, 123, 119, 17,
            55, 116, 197, 52, 11, 44, 204, 50, 193, 41
        };
